<form name="form_add" method="post">
    <div class="column">
        ...
        <div class="add">
            ...
            <input type="text" name="lastname" placeholder="Отчество" value="<?= $row['lastname']; ?>">
        </div>
        <div class="add">
            <label>Пол</label> 
            <select name="gender">
        ...
        <div class="add">
            ...
            <input type="date" name="birth_date" placeholder="Дата рождения" value="<?= $row['birth_date'] ?>">
        </div>
        <div class="add">
            <label>Телефон</label> 
            <input type="text" name="phone" placeholder="Телефон" value="<?= $row['phone']; ?>">
        </div>
        <div class="add">
            <label>Адрес</label>
        ...
        <div class="add">
            ...
            <textarea name="comment" placeholder="Краткий комментарий"><?= $row['comment']; ?></textarea>
        </div>
